...
dat <- raw_dat %>% 
  ...
  mutate(
    biotecnologia = str_to_upper(gsub(',', '\\.', biotecnologia)), 
    biotecnologia = recode(biotecnologia,  # cambios manuales
                           'STS + INTACTA'= 'INTACTA + STS',
                           'RR1'= 'RR'), 
    biotecnologia = str_replace_all(biotecnologia, c('INTACTA'), "IPRO"),
) %>% 
